...
resource "aws_iam_role" "codepipeline" {
  name_prefix = "${var.project_name}-${var.environment}-codepipeline"
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = [
          aws_codebuild_project.finance_trading.arn,
          aws_codebuild_project.pharma_manufacturing.arn
        ]
      },
      {
        Effect = "Allow"
...
# EventBridge IAM role for SNS publishing
